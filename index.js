...
/#take [金], /#fi-game, /#st-gya, /#fi-gya, /#blacklist 等[/info]`;
            ...
            const cJobMatch = body.match(/(^|\n)[/#]job\s+(サラリーマン|公務員|警察官|プロスポーツ選手|賭博師|ギャンブルオーナー|未来人|逆転のギャンブラー|銀行員|大富豪の執事|賞金稼ぎ|数学者|パチプロ|てんびん|隻眼|トレーダー|保険屋|カジノ王|占い師|シェフ|極道|エボリューショナー|Fixer|Terminal|Photographer)/);
