...
/russian : ロシアンルーレット募集 (対人戦専用。/shoot で撃ち合い)
...
/take [金], /fi-game, /st-gya, /fi-gya, /blacklist 等[/info]`;
            ...
            if (body.trim() === '/shoot' && gambleActive && gameState[roomId]?.type === 'russian' && gameState[roomId].state === 'ACTION') {
                let g = gameState[roomId];
